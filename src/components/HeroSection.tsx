          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="mt-6 grid grid-cols-3 gap-2">
                ...
                <a
                  href="#uslugi"
                  className="rounded-2xl border border-white/10 bg-[rgba(5,15,20,0.60)] hover:bg-[rgba(5,15,20,0.68)] shadow-sm hover:shadow-md transition-colors p-4 text-white min-h-[140px]"
                >
                  <div className="flex items-start gap-3">
                    <span className="text-[#2F9959] shrink-0 mt-0.5">
                      <ShieldIcon size={26} />
                    </span>
                    <h3 className="font-head font-semibold text-[18px] sm:text-[19px] leading-[1.15]">
                      System alarmowy
                    </h3>
                  </div>
                  <p className="mt-2 pl-[29px] text-[14px] leading-[1.35] text-white/85 font-body">
                ...
                >
                  <div className="flex items-start gap-3">
                    <span className="text-[#2F9959] shrink-0 mt-0.5">
                      <CctvIcon className="w-[26px] h-[26px]" />
                    </span>
                    <h3 className="font-head font-semibold text-[18px] sm:text-[19px] leading-[1.15]">
                      Monitoring CCTV
                    </h3>
